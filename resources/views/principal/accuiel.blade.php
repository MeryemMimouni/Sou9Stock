    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                <!-- Lien vers la page principale.service -->
                ...
                <div class="carousel-inner">
                    @foreach($products as $key => $product)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <img src="{{ asset($product->image) }}" class="d-block w-100" style="max-height: 645px;" alt="{{ $product->title }}">
                            <!-- Ajustez la valeur de max-height selon vos besoins -->
                        </div>
                    @endforeach
                </div>
            ...
            <div class="row">
                @foreach ($category->products->take(4) as $product)
                    <div class="col-md-3 mb-4">
                        <div class="card">
                            <img src="{{ asset($product->image) }}" class="card-img-top fixed-image-size" alt="{{ $product->title }}">
                            <div class="card-body">
...
<!-- Ajouter le style CSS pour la classe fixed-image-size -->
<style>
    .fixed-image-size {
